...
Аппаче достаточно ставить только на 1 инстанс!! Инициировать через путти достаточно тот инстанс с апаче. 
...
5 – Распространённые проблемы EC2

6 – Распространённые проблемы VPC

7 – Распространённые проблемы ELB

8 – Распространённые проблемы при автомасштабировании
